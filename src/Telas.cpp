...
char TelaMenuUsuario::apresentar() {
    ...
    mvprintw(linha/4 + 4,(coluna-strlen(campo3))/2,"%s",campo3);
    mvprintw(linha/4 + 6,(coluna-strlen(campo3))/2,"%s",campo4);
    mvprintw(linha/4 + 8,(coluna-strlen(campo3))/2,"%s",campo5);
    getstr(dado1);
    clear();
    endwin();
...
char TelaMenuAutenticado::apresentar() {
    ...
    mvprintw(linha/4 + 2,(coluna-strlen(campo2))/2,"%s",campo2);
    mvprintw(linha/4 + 4,(coluna-strlen(campo3))/2,"%s",campo3);
    mvprintw(linha/4 + 6,(coluna-strlen(campo4))/2,"%s",campo4);
    getstr(dado1);
    clear();
    endwin();
